        ...
        <div class="card">
            <div class="card-body pt-3">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                    ...
                    <!--Form -->
                    <form method="post" id="registFrm" action="/main/studyregist">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input class="p-1" type="file" name="files" id="file" multiple onchange="">
                            </div>
                        </div>
                        <div class="row mb-3">
...
<script>
    ...
    tagsAddBtn.addEventListener("click", function(e){
        ...
        let innerText = "";
        innerText += '<div class="col-9">'
        innerText += '<input type="text" class="form-control tagsList" id=`${id}` value="">';
        innerText += '</div>';
        innerText += '<div class="col-3">';
